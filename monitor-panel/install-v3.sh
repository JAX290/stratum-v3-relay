...
required=(v3-config.json v3_manager.py endpoint_monitor.py security_monitor.py stratum_inspector.py stratum_admin_v3.py)
...
install -m 0755 v3_manager.py endpoint_monitor.py security_monitor.py stratum_inspector.py stratum_admin_v3.py /opt/stratum-admin/
...
systemctl --no-pager --full status stratum-inspector-v3.service stratum-endpoint-monitor.service stratum-security-monitor.service stratum-admin.service haproxy
