...
$sources=@('AppIdentity.cs','ConfigModels.cs','RelayManager.cs','RelayStatus.cs','FailoverPolicy.cs','RelayFailoverController.cs','NetworkHelper.cs','NetworkRecovery.cs',
