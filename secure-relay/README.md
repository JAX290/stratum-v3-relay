...
当前源码版本 `2.2.2` 完成中转核心、状态统计、历史存储和窗口源码分离，使用步骤、配置位置与主备连接行为保持兼容。本阶段尚未提供无需登录的 Windows 服务；验收与发布状态见[路线计划](../docs/improvement-roadmap.md)。开发与测试入口见[客户端源码结构](client/src/ARCHITECTURE.md)。
